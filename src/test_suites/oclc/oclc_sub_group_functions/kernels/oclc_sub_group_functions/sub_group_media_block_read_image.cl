...
test_kernel_sub_group_media_block_read_image(
    read_only image2d_t image, __global INPUT_DATA_TYPE *output_data) {
...
#if VECTOR_SIZE > 1
    output_data[indexes[i]] = read_data[i];
#else
    output_data[indexes[i]] = read_data;
#endif
  }
};

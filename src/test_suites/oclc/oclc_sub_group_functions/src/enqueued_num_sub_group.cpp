...
TEMPLATE_LIST_TEST_CASE_CUSTOM_NAME("enqueued_num_sub_group", "", OneTestType,
  ...
  std::string test_func_name = "enqueued_num_sub_group";
  ...
  SECTION("1D") {
    test_enqueued_num_subgroup<TestType, 1>(get_test_config(), test_func_name);
  }
  SECTION("2D") {
    test_enqueued_num_subgroup<TestType, 2>(get_test_config(), test_func_name);
  }
  SECTION("3D") {
    test_enqueued_num_subgroup<TestType, 3>(get_test_config(), test_func_name);
  }
}

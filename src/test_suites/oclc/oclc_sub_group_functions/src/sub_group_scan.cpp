...
TEMPLATE_LIST_TEST_CASE_CUSTOM_NAME("sub_group_scan_inclusive_min", "",
  ...
  std::string func_name = "sub_group_scan_inclusive_min";
...
TEMPLATE_LIST_TEST_CASE_CUSTOM_NAME("sub_group_scan_inclusive_max", "",
  ...
  ca::Requirements requirements;
  requirements.arithmetic_type<scalar_type>();
  std::string func_name = "sub_group_scan_inclusive_max";
  if (ca::should_skip_test(requirements, *config.runtime())) {
    return;
  }
  SECTION("1D") {
...
TEMPLATE_LIST_TEST_CASE_CUSTOM_NAME("sub_group_scan_inclusive_add", "",
  ...
  ca::Requirements requirements;
  requirements.arithmetic_type<scalar_type>();
  std::string func_name = "sub_group_scan_inclusive_add";
  if (ca::should_skip_test(requirements, *config.runtime())) {
    return;
  }
  SECTION("1D") {
...
TEMPLATE_LIST_TEST_CASE_CUSTOM_NAME("sub_group_scan_exclusive_min", "",
  ...
  ca::Requirements requirements;
  requirements.arithmetic_type<scalar_type>();
  std::string func_name = "sub_group_scan_exclusive_min";
  if (ca::should_skip_test(requirements, *config.runtime())) {
    return;
  }
  SECTION("1D") {
...
TEMPLATE_LIST_TEST_CASE_CUSTOM_NAME("sub_group_scan_exclusive_max", "",
  ...
  ca::Requirements requirements;
  requirements.arithmetic_type<scalar_type>();
  std::string func_name = "sub_group_scan_exclusive_max";
  if (ca::should_skip_test(requirements, *config.runtime())) {
    return;
  }
  SECTION("1D") {
...
TEMPLATE_LIST_TEST_CASE_CUSTOM_NAME("sub_group_scan_exclusive_add", "",
  ...
  ca::Requirements requirements;
  requirements.arithmetic_type<scalar_type>();
  std::string func_name = "sub_group_scan_exclusive_add";
  if (ca::should_skip_test(requirements, *config.runtime())) {
    return;
  }
  SECTION("1D") {

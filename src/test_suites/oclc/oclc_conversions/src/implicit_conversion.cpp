...
TEMPLATE_LIST_TEST_CASE_CUSTOM_NAME("implicit conversion", "",
                                    ca::ScalarToVector2, test_name<TestType>) {
  scalar_to_vector<TestType>(program);
}

TEMPLATE_LIST_TEST_CASE_CUSTOM_NAME("implicit conversion", "",
                                    ca::ScalarToVector3, test_name<TestType>) {
  scalar_to_vector<TestType>(program);
}

TEMPLATE_LIST_TEST_CASE_CUSTOM_NAME("implicit conversion", "",
                                    ca::ScalarToVector4, test_name<TestType>) {
  scalar_to_vector<TestType>(program);
}

TEMPLATE_LIST_TEST_CASE_CUSTOM_NAME("implicit conversion", "",
                                    ca::ScalarToVector8, test_name<TestType>) {
  scalar_to_vector<TestType>(program);
}

TEMPLATE_LIST_TEST_CASE_CUSTOM_NAME("implicit conversion", "",
                                    ca::ScalarToVector16, test_name<TestType>) {
  scalar_to_vector<TestType>(program);
}
